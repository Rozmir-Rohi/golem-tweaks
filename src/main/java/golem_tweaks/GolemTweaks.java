...
import golem_tweaks.proxy.CommonProxy;
import net.minecraftforge.common.MinecraftForge;
import net.minecraftforge.common.config.Configuration;

@Mod(modid = "GolemTweaks", name = "Golem Tweaks", version = "1.3.4")
public class GolemTweaks
{
	@SidedProxy(clientSide = "golem_tweaks.proxy.ClientProxy", serverSide = "golem_tweaks.proxy.CommonProxy")
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        EntityRegistry.registerModEntity(EntityIronGolemExtension.class, "iron_golem", modEntityID++, this, 50, 2, true);
        EntityRegistry.registerModEntity(EntitySnowGolemExtension.class, "snow_golem", modEntityID++, this, 50, 2, true);
        
        if (enableSnowGolemBuffs)
        {
        	EntityRegistry.registerModEntity(EntitySnowballExtension.class, "snowball", modEntityID++, this, 50, 2, true);
        }
        
        MinecraftForge.EVENT_BUS.register(new ReplaceVanillaGolemsEvent());
    ...
    public static void syncConfigSettings()
    {
    	...
    	enableIronGolemCracking = configFile.getBoolean("enableIronGolemCracking", "general", true, "If True: Iron Golems will have thier cracking textures from 1.15 when they are hurt, they will also make their cracking sound in different damage stages. This will also override textures from texture packs for Iron Golems.");
